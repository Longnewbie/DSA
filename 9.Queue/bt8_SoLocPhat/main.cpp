...
/*
	...
	- Input Format: Dòng đầu tiên ghi lại số tự nhiên T là số lượng bộ test (T < 10); T dòng kế tiếp mỗi dòng ghi số N.

	- Output Format: In ra đáp án theo thứ tự giảm dần.
