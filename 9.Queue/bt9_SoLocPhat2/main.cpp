...
/*
	...
	- Input Format: • Dòng đầu tiên ghi lại số tự nhiên T là số lượng bộ test (T<10); 
					• T dòng kế tiếp mỗi dòng ghi số N.

	- Output Format: Dòng đầu tiên là số lượng số lộc phát tìm được. Dòng thứ hai in đáp án theo thứ tự tăng dần.
