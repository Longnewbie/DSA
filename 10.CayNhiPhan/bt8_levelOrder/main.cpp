...
/*
	- Cho cây nhị phân, nhiệm vụ của bạn là duyệt cây theo mức. Ví dụ cây nhị phân dưới đây sẽ có thứ tự duyệt theo mức như
	  sau : 1 2 3 4 5 6 7
	...
	- Output Format: In ra thứ tự duyệt theo mức.
