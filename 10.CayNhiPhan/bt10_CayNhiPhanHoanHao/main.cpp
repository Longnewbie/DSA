...
/*
	- Cho cây nhị phân, nhiệm vụ của bạn là kiểm tra xem cây nhị phân đã cho có phải là cây nhị phân hoàn hảo hay không. Cây 
	  nhị phân hoàn hảo nếu mọi node lá của nó có cùng mức và mỗi node trung gian đều có 2 con.
	...
	- Output Format: In ra YES hoặc NO tùy theo kết quả của bài toán.
