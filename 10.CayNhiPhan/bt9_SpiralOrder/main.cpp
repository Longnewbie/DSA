...
/*
	- Cho cây nhị phân, nhiệm vụ của bạn in ra thứ tự duyệt cây kiểu xoắn ốc. Ví dụ với cây nhị phân bên dưới thì thứ tự duyệt 
	  xoắn ốc sẽ là : 1 2 3 7 6 5 4
	...
	- Output Format: In ra thứ tự duyệt theo kiểu xoắn ốc.
