...
/*
	- Cho cây nhị phân, nhiệm vụ của bạn là duyệt cây theo thứ tự Postorder. Thứ tự duyệt Postorder của cây nhị phân bên dưới
	...
	- Output Format: In ra thứ tự duyệt cây Postorder.
