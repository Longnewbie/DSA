...
/*
	- Cho cây nhị phân, nhiệm vụ của bạn là duyệt cây theo thứ tự Inorder. Thứ tự duyệt Inorder của cây nhị phân bên dưới xuất
	  hiện trong test case mẫu.
	...
	- Output Format: In ra thứ tự duyệt cây Inorder.
